#
# jpeg 8c makefile for Android NDK
#
...
LOCAL_SRC_FILES := src/jaricom.c src/jcapimin.c src/jcapistd.c src/jcarith.c src/jccoefct.c src/jccolor.c \
                   ...
                   src/jquant2.c src/jutils.c src/jmemmgr.c src/jmemnobs.c
